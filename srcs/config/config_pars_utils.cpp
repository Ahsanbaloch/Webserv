...
/*   Updated: 2024/04/20 21:17:55 by ahsalam          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void rootValueCheck(t_location_config &location_config, std::string rootValue, std::string &_server_root)
{
	rootValue = removeMultipleSlashes(rootValue);
	_server_root = removeMultipleSlashes(rootValue);
