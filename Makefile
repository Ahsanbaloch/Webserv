...
SRCS := $(addprefix $(SRCS_DIR),ListeningSocket.cpp ListeningSocketsBlock.cpp RequestHandler.cpp Header.cpp ARequest.cpp GETRequest.cpp DELETERequest.cpp ERRORRequest.cpp Response.cpp ConnectionHandler.cpp main.cpp config/config_pars_utils.cpp config/config_pars.cpp config/exception_parsing.cpp)
