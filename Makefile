...
SRCS := $(addprefix $(SRCS_DIR),ListeningSocket.cpp ListeningSocketsBlock.cpp RequestHandler.cpp RequestHeader.cpp AResponse.cpp GETResponse.cpp DELETEResponse.cpp ERRORResponse.cpp POSTResponse.cpp REDIRECTResponse.cpp ConnectionHandler.cpp AUploadModule.cpp UploadMultipart.cpp UploadPlain.cpp UploadUrlencoded.cpp main.cpp config/config_pars_utils.cpp config/config_pars.cpp config/exception_parsing.cpp)
